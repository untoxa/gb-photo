...
Set the `GBDK_HOME` environment variable which targets your GBDK-2020 folder. Best is to stay with the default GBDK_HOME = C:/GBDK. In case of systematic error with makebin, manually modify the Makefile like this: GBDK_HOME = "C:/GBDK/"
